...
public class BleModule extends ReactContextBaseJavaModule {
	...
	public void advertise(String deviceName, Callback advCallBack) {
		...
		AdvertiseSettings advertiseSettings = new AdvertiseSettings.Builder()
			...
			.setConnectable(true)	// allow connection establishment with peripheral devices
			.build();
		...
		AdvertiseData advertiseData = new AdvertiseData.Builder()
			...
			.setIncludeTxPowerLevel(true)	// include transmission power level
			.build();
	...
	*/
	...
	public void stopBroadcastingGATT(Callback advsrvCallBack) {
		...
		try {
			...
			Log.e("stopAdvert fail", err.getMessage());
			adv = false;
		}
		...
		try {
			...
			Log.e("stop GATT server fail", err.getMessage());
			srv = false;
		}
